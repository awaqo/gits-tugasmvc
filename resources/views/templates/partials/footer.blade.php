    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 md:w-1/3">
                <div>
                    <img src="{{ asset('logomark.svg') }}" alt="Logo" class="mb-5">
                </div>
            ...
            <div class="w-full px-4 mb-12 md:w-1/3">
                ...
                <ul class="text-slate-300">
                    <li>
                        <a href="{{ route('home') }}" class="inline-block text-base mb-3 hover:text-white">Home</a>
                    </li>
                    <li>
                        <a href="{{ route('about-me') }}" class="inline-block text-base mb-3 hover:text-white">About Me</a>
                    </li>
                    <li>
                        <a href="{{ route('data-list') }}" class="inline-block text-base mb-3 hover:text-white">Data List</a>
                    </li>
                    <li>
                        <a href="{{ route('contact') }}" class="inline-block text-base mb-3 hover:text-white">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="w-full pt-10 border-t border-slate-700">
            <div class="flex items-center justify-center mb-5">
                <!-- Instagram -->
                <a href="https://instagram.com/aqiljf_" target="_blank" class="w-9 h-9 text-slate-300 mr-3 rounded-full flex items-center justify-center border border-slate-300 hover:border-blue-600 hover:bg-blue-600 hover:text-white">
                ...
                <!-- Github -->
                <a href="https://github.com/awaqo" target="_blank" class="w-9 h-9 text-slate-300 mr-3 rounded-full flex items-center justify-center border border-slate-300 hover:border-blue-600 hover:bg-blue-600 hover:text-white">
                ...
                <!-- Dribbble -->
                <a href="https://dribbble.com/awaqo" target="_blank" class="w-9 h-9 text-slate-300 mr-3 rounded-full flex items-center justify-center border border-slate-300 hover:border-blue-600 hover:bg-blue-600 hover:text-white">
                ...
                <!-- LinkedIn -->
                <a href="https://linkedin.com/in/aqiljawadal" target="_blank" class="w-9 h-9 text-slate-300 mr-3 rounded-full flex items-center justify-center border border-slate-300 hover:border-blue-600 hover:bg-blue-600 hover:text-white">
            ...
            <p class="font-medium text-xs text-slate-500 text-center mb-2">Dibuat dengan <a href="https://instagram.com/aqiljf_" target="_blank" class="text-white hover:text-blue-400">{{ $user }}</a></p>
